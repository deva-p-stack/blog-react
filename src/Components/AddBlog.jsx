...
return(
    ...
    <div className="grid grid-cols-1 md:grid-cols-2  gap-4  ">
            ...
            <div className="flex flex-col py-1 space-x-3 space-y-0.5 ">
            ...
            <div className="flex flex-col pt-1.5 space-x-3 space-y-0.5 ">
            ...
            <div className="flex flex-col py-1 space-x-3 space-y-0.5">
             ...
             <div className="flex flex-col py-1 space-x-3 space-y-0.5 ">
                ...
                <input onChange={(e)=> setBlog({...blog,status: e.target.value})} className="bg-red-400 outline-none rounded-lg py-2 px-3" type="text" name="status" id="status" aria-label="status" />
                  ...
                  <div className="flex flex-col col-span-full py-1 space-x-3 space-y-0.5 ">
                ...
                <div className=" flex justify-center items-center py-3">
                    <button onClick={handledata} className="px-3 w-[50%] py-2 hover:bg-red-300 bg-red-400 rounded  cursor-pointer active:scale-95 transition-all ease-in-out duration-300 "  type="submit">
